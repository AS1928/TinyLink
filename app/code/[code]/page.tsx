  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800">
      <div className="container mx-auto px-4 py-8">
        <button
          onClick={() => router.push("/")}
          className="text-blue-400 hover:text-blue-300 mb-8 flex items-center gap-2 underline underline-offset-4 decoration-purple-500 decoration-2  hover:scale-105 transition-transform"
        >
